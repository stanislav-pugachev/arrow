...
> Открыть эту страницу в [https://stanislav-pugachev.github.io/arrow/](https://stanislav-pugachev.github.io/arrow/)
...
* найдите **https://github.com/stanislav-pugachev/arrow** и импортируйте

## Править этот проект ![Значок статуса сборки](https://github.com/stanislav-pugachev/arrow/workflows/MakeCode/badge.svg)

Редактировать этот репозиторий в MakeCode.

* открыть [https://makecode.microbit.org/](https://makecode.microbit.org/)
* нажмите на **Импорт**, затем **Импорт URL**
* вставьте **https://github.com/stanislav-pugachev/arrow** и нажмите Импорт
...
![Отрисовка в виде блоков](https://github.com/stanislav-pugachev/arrow/raw/master/.github/makecode/blocks.png)
